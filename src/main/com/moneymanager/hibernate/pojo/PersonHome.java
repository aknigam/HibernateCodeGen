 ...
 * @see com.moneymanager.hibernate.pojo.Person
...
public class PersonHome {
    ...
    public Person findById( long id) {
        ...
        try {
            Person instance = (Person) sessionFactory.getCurrentSession()
                    .get("com.moneymanager.hibernate.pojo.Person", id);
            if (instance==null) {
    ...
    public List findByExample(Person instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("com.moneymanager.hibernate.pojo.Person")
