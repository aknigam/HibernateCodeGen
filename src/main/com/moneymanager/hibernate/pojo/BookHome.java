 ...
 * @see com.moneymanager.hibernate.pojo.Book
...
public class BookHome {
    ...
    public Book merge(Book detachedInstance) {
        ...
        try {
            Book result = (Book) sessionFactory.getCurrentSession()
    ...
    public Book findById( int id) {
        ...
        try {
            Book instance = (Book) sessionFactory.getCurrentSession()
                    .get("com.moneymanager.hibernate.pojo.Book", id);
            if (instance==null) {
    ...
    public List findByExample(Book instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("com.moneymanager.hibernate.pojo.Book")
