 ...
 * @see com.moneymanager.hibernate.pojo.Chapter
...
public class ChapterHome {
    ...
    public Chapter merge(Chapter detachedInstance) {
        ...
        try {
            Chapter result = (Chapter) sessionFactory.getCurrentSession()
    ...
    public Chapter findById( java.lang.Integer id) {
        ...
        try {
            Chapter instance = (Chapter) sessionFactory.getCurrentSession()
                    .get("com.moneymanager.hibernate.pojo.Chapter", id);
            if (instance==null) {
    ...
    public List findByExample(Chapter instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("com.moneymanager.hibernate.pojo.Chapter")
